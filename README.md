Il s'agit d'une application développée en langage kotlin et affichant un pokédex ainsi que les informations d'un pokémon. Cette application utilise l'API Rest PokeApi.
